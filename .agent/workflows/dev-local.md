...
> This starts both MongoDB (database) and RabbitMQ (message broker).
...
> **Note**: The backend now automatically launches the `Device Simulator` in the background. You no longer need to run a separate simulation script.
